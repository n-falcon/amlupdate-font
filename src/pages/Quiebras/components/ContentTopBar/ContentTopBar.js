  ...
  return (
    <div className="content-top-bar">
      <div className="cake-wrapper">
        <CakeChart isLoading={ isLoading } firstLoading={ firstLoading } totalNum={ colorsCake.total } riskCritical={ colorsCake.critical } riskHigh={ colorsCake.high } riskMedium={ colorsCake.medium } riskLow={ colorsCake.low } riskNa={ colorsCake.na } />
      </div>
