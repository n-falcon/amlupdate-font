...
const FormKyc = ({ form, match }) => {
  ...
  const basicInfoIS= {
    ...
    basicInfoNomFacturacion: { key:"nombreFacturacion",val: "", title: "Nombre y Apellidos", id:"basicInfoNomFacturacion", readOnly: true, section: 'facturacion' },
    ...
    basicInfoCelFacturacion: { key:"celFacturacion",val: "", title: "Teléfono Celular", id:"basicInfoCelFacturacion", readOnly: true, section: 'facturacion' },
    basicInfoTelFacturacion: { key:"telFacturacion",val: "", title: "Teléfono Fijo", id:"basicInfoTelFacturacion", readOnly: true, section: 'facturacion' },
  };
  ...
  const handlerOnChangeObjAttr = async (sectionId, value, formObj) => {
    ...
    const json = { basicInformation: basicInfo, repLegal: rLegal, infoEco: iEco, ofCumplimiento: oCump, infoPep: iPep, benFinales: bFin, fondos: fond, sociedades: socR }
            ...
            {apiForm !== null ? (
              ...
              >
                <Form onSubmit={handleSubmit} className="form-form">
                  ...
                  >
                    ...
                    <Col
                      ...
                      xl={colLogo}
                    >
                      <Logo currentUser={{ userId: user.id, subclienteId: '0' }} />
                    </Col>
                  </Row>
                  <Row
                    className="date"
                  ...
                  <>
                    ...
                    <div className="content">
                      {format === "html" && !signed && (
                        ...
                        {/* ↓ CAMPO INICIO DE ACTIVIDADES ↓ */}
                          ...
                          {/* ↓CAMPO ANIOS DE EXPERIENCIA↓ */}
                            ...
                            {renderFormItemTable({
                              section: infoEco.infoEcoPais,
                              cols: 5,
                              options:[
                              {val: 'Chile', text: 'Chile'}
                              ]
                              // paises.map(item => {
                              //   return {val: item.country, text: item.country}
                              // })
                      ...
                      {/* <Row className="subheader">
                        <Col xl={24}>
                          III. INFORMACIÓN SOBRE CUENTAS EN MONEDA EXTRANJERA
                        </Col>
                      </Row>
                      <Row>
                      ...
                      {infoEco.infoEcoHasExMon.val && (
                        ...
                        <Row className="subheader">
                          <Col xl={24}>
                            IV. INFORMACIÓN RESPECTO AL ORIGEN DE FONDOS
                          </Col>
                        </Row>
                        <div className="content">
                      ...
                      <Row className="subheader">
                        <Col xl={24}>
                          V. INFORMACIÓN DE PERSONA EXPUESTA POLÍTICAMENTE O PÚBLICAMENTE (PEP)
                        </Col>
                      </Row>
                      <Row className="summary">
                        <Col xl={24}>
                      ...
                      <>
                        <Row className="subheader">
                          <Col xl={24}>
                            VI. IDENTIFICACIÓN DE LOS BENEFICIARIOS FINALES.
                          </Col>
                        </Row>
                        <div className="content">
                          <Row className="summary">
                        ...
                        <Row className="subheader">
                          <Col xl={24}>
                            { apiForm.typeSol === 'PJ' ? 'VII.' : 'VI.' } INFORMACIÓN RESPECTO A LA PARTICIPACIÓN EN SOCIEDADES
                          </Col>
                        </Row>
                        <Row className="summary">
                        <Col span={20}>
                    ...
                    {apiForm.typeSol === 'PN' &&
                      <>
                        <Row className="subheader">
                          <Col xl={24}>
                            VII. DECLARACIÓN DE PREVENCIÓN DEL LAVADO DE ACTIVOS Y FINANCIACIÓN AL TERRORISMO
                          </Col>
                        </Row>
                        <div className="content">
                          <Row className="summary">
                            ...
                            <ol>
                              <li>
                                Los recursos, fondos, dineros, productos y activos destinados a la ejecución
                                de la relación comercial y contractual con Parque Arauco S.A. y sus filiales no
                                provienen de ninguna actividad sancionada por el Código Penal Chileno u otras
                                normas que establezcan delitos base de lavado de activos.
                              </li>
                              <li>
                                Mis actividades comerciales no están vinculadas, directa ni indirectamente,
                                con el lavado de activos o con alguno de sus delitos base, ni con el
                                financiamiento del terrorismo.
                              </li>
                              <li>
                                En el caso que importe productos para su comercialización,
                                éstos han sido legalmente internados al país y cuentan con todos los
                                permisos y licencias que corresponden.
                              </li>
                              <li>
                                No me encuentro incluido en ninguno de los listados de las
                                Resoluciones del Consejo de Seguridad de Naciones Unidas que
                                sancionan el financiamiento del terrorismo y el financiamiento de
                                la proliferación de armas de destrucción masiva.
                              </li>
                              <li>
                                No he sido condenado/a bajo la ley chilena o extranjera por los
                                delitos de lavado de activos, o alguno de sus delitos base, o por
                                financiamiento del terrorismo.
                              </li>
                              <li>
                                En el evento de tomar conocimiento de un cambio en las circunstancias
                                descritas anteriormente, dicha situación la comunicaré de
                                inmediato al oficial de cumplimiento de Parque Arauco S.A. y
                                sus filiales, al mpd@parauco.com.
                              </li>
                              <li>
                                Conozco y acepto que:
                              </li>
                            </ol>
                              i) Parque Arauco S.A. y sus filiales está facultada para
                                efectuar las verificaciones que considere pertinentes y está en
                                la obligación legal de solicitar las aclaraciones que estime adecuadas
                                respecto de mis actividades comerciales y del origen de mis activos,
                                información que me obligo a entregar oportunamente. <br/>
                              ii) Las declaraciones serán efectivas y veraces durante toda la vigencia de
                              la relación contractual con Parque Arauco S.A. y sus filiales. <br/>
                              iii) En caso de incumplimiento, incongruencia o discrepancia respecto
                              de las obligaciones y declaraciones incorporadas en el presente
                              documento, Parque Arauco S.A. y sus filiales podrá dar por terminada
                              con justa causa cualquier relación comercial o contractual que exista,
                              y no tendré derecho a indemnización alguna.
                            </Col>
                          </Row>
                        </div>
                      </>
                ...
                {apiForm.typeSol === 'PJ' &&
                  <>
                      <Row className="subheader">
                        <Col xl={24}>{apiForm.typeSol === 'PJ' ? 'VIII' : 'VI'}. DECLARACIÓN SOBRE GESTIÓN DEL RIESGO & COMPLIANCE</Col>
                      </Row>
                      <Row className="summary">
                        <Col xl={24}>
                    ...
                    {apiForm.typeSol === 'PJ' &&
                      ...
                      <Row className="subheader">
                        <Col xl={24}>
                          {apiForm.typeSol === 'PJ' ? 'IX. ' : 'VIII. '} Documentos Adjuntos.
                        </Col>
                      </Row>
                      <Row className="summary" style={{marginBottom:20}}>
                        A continuación, adjunte la carpeta tributaria con una extracción no mayor a 30 días.
                        Recuerde que debe indicar el nombre del documento que adjuntará.
                        Puede adjuntar documentos en formato pdf, jpg, word, excel cuyo
                        peso no supere los 2MB por archivo. En total se pueden adjuntar
                        hasta 10 archivos.
                      </Row>
                      { format === 'pdf' ?
                        <Row>
                      ...
                      <Row className="subheader">
                        <Col xl={24}>
                          {apiForm.typeSol === 'PJ' ? 'X. ' : 'IX. '} {apiForm.typeSol === 'PJ' ? 'FIRMA DEL REPRESENTANTE LEGAL' : 'FIRMA'}
                        </Col>
                      </Row>
