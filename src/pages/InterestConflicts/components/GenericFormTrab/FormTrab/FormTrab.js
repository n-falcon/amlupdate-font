...
import { getDomainPromise } from "../../../../Stakeholder/promises";
  ...
  useEffect(() => {
    ...
    getFormPromise(idForm).then((response) => {
      ...
      if (
        ...
        getDomainPromise(match.params.cliente).then((res) => {
          let clienteId = responseData.recipient.request.createUser.cliente.id ?? undefined;
          if(clienteId){
            if(res.data.id != clienteId){
              setGranted(false);
            }else{
              setGranted(true);
            }
        ...
        (
          <>
            {apiForm !== null ? (
              ...
              !granted ? <h2>Acceso no permitido</h2>
              :
              <div
                className={
                  "form-content" +
                        ...
                        <>
                          ...
                          <Row className="summary">
                            <Col xl={24}>
                              ...
                              , declaro conocer: el Código de Ética de{" "}
                              <strong>
                              ...
                              {" "} así mismo tengo el deber de informar
                              sobre cualquier situación que pueda dar origen
                               a un potencial conflicto de interés en el desempeño
                                de mis funciones de acuerdo a lo establecido
                                en el {" "}
                              <Tooltip
                                placement="leftTop"
                          ...
                          <Row className="subheader">
                            <Col xl={24}>
                              III. RELACIÓN CON PROVEEDORES, CONTRATISTAS, Y/O CLIENTES INSTITUCIONALES DE LA EMPRESA{" "}
                            </Col>
                          </Row>
                          <Row className="summary">
                            <Col span={21}>
                              Declaro que tengo participación, directa o indirectamente, o lo hace mi cónyuge, conviviente civil y/o parientes hasta el segundo grado de{" "}
                              <Tooltip
                                className="tooltip-form"
                                title="Hasta segundo grado de consanguinidad, se consideran padres, hijos, abuelos, nietos y hermanos"
                              >
                          ...
                          <Row className="subheader">
                            <Col xl={24}>
                              V. ACTIVIDADES FUERA DE LA EMPRESA Y DEL HORARIO
                              LABORAL
                            </Col>
                          </Row>
                          <Row className="summary">
                          ...
                          <Row className="subheader">
                            <Col xl={24}>VI. RELACIÓN CON LA COMPETENCIA</Col>
                          </Row>
                          <Row className="summary">
                            <Col span={21}>
                          ...
                          <Row className="subheader">
                            <Col xl={24}>
                              VII. RELACIÓN DE PARENTESCO O DE PAREJA{" "}
                            </Col>
                          </Row>
                          <Row className="summary">
                            <Col span={21}>
                              ...
                              de La Empresa o es mi conyuge o conviviente civil.
                            </Col>
                            {renderFormItem({
                              label: "",
                          ...
                          <Row className="subheader">
                            <Col xl={24}>
                              VIII. RELACIÓN CON FUNCIONARIOS PUBLICOS Y/O
                          ...
                          <Row className="subheader">
                            <Col xl={24}>
                            IX. RELACIÓN CON FUNDACIONES, CORPORACIONES, INSTITUCIONES DE BENEFICIENCIA Y/O SIN FINES DE LUCRO
                            </Col>
                          </Row>
                          <Row className="summary">
                            <Col span={21}>
                              Declaro que participo, directa o indirectamente, o
                              lo hace mi cónyuge, conviviente civil y/o
                              parientes hasta el segundo grado de{" "}
                              <Tooltip
                                className="tooltip-form"
                                title="Hasta segundo grado de consanguinidad, se consideran padres, hijos, abuelos, nietos y hermanos"
                          ...
                          <Row className="subheader">
                            <Col xl={24}>X. OTROS CONFLICTOS DE INTERÉS</Col>
                          </Row>
                          <Row className="summary">
                            <Col span={21}>
                          ...
                          <Row className="subheader">
                            <Col xl={24}>
                              XI. CONOCIMIENTO DEL USO DE INFORMACIÓN
                          ...
                          <Row className="subheader">
                            <Col xl={24}>
                              XII. CONOCIMIENTO DE LA LEY N°20.393 SOBRE
                          ...
                          >
                            ...
                            <Row className="subheader">
                            <Col xl={24}>
                              XIII. Declaración de Responsabilidad
                            </Col>
                          </Row>
                          <Row className="summary">
                            <Col xl={24}>
