                        ...
                        <>
                          ...
                          <Row className="summary">
                            <Col xl={24}>
                              ...
                              , en adelante "La Empresa", sociedad perteneciente
                              al{" "}
                              {getTooltipEmpresas('Grupo SMU')}
                              {" "}
                              (se entenderá dentro de este concepto a todas
                              aquellas sociedades relacionadas de acuerdo
                              al&nbsp;
                              <Tooltip
                                placement="leftTop"
