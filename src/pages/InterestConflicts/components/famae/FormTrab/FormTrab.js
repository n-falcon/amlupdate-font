...
const FormTrab = ({ form, match }) => {
  ...
  const competenciaIS = {
    ...
    competenciaCompanyTipoDoc: { key: "companyTipoDoc", id:"competenciaCompanyTipoDoc", val: "", title: "Tipo de Documento de Empresa de la Competencia"},
    ...
    competenciaTipoDoc: { key: "rut", id:"competenciaTipoDoc", val: "", title: "Tipo de documento de la Persona" },
  ...
  const relationParentescoIS = {
    ...
    relationParentescoRut: { key: "rut", id:"relationParentescoRut", val: "", maxLength:20, readOnly:true, type:'input', title: "Documento"  },
    ...
    relationParentescoCompanyName: { key: "companyName", id:"relationParentescoCompanyName", val: "", title: "Empresa", },
  }
  ...
  const relationPepIS = {
    ...
    relationPepRut: { key: "field4", id:"relationPepRut", val: "", maxLength:20, readOnly:true, type:'input', title: "Documento"  },
                        ...
                        <>
                          ...
                          <Row className="summary">
                            <Col xl={24}>
                              ...
                              , declaro: conocer el Código de Ética y Conducta
                              de{" "}
                              <strong>
                              ...
                              , en adelante <em>"La Empresa"</em>, mi deber de informar 
                              sobre cualquier situación que pueda dar origen a un
                               potencial conflicto de interés en el desempeño de 
                               mis funciones y la necesidad de informar a la Empresa, 
                               de acuerdo al&nbsp;
                               {/*
                              <Tooltip
                                placement="leftTop"
                              ...
                              <Tooltip
                                ...
                                title={() => (
                                  <>
                                    ...
                                    Sobre probidad en la función pública y
                                    ...
                                    <br />
                                    Existe conflicto de intereses en el ejercicio
                                    de la función pública cuando concurren a la
                                    vez el interés general propio del ejercicio de
                                    las funciones con un interés particular, sea
                                    o no de carácter económico, de quien ejerce
                                    dichas funciones o de los terceros vinculados
                                    a él determinados por la ley, o cuando concurren
                                    circunstancias que le restan imparcialidad en
                                    el ejercicio de sus competencias."
                                    
                                  </>
                                )}
                              >
                                al artículo 1 de la Ley N°20.880
                              </Tooltip>
                                */}
                              artículo 100 de la Ley N° 18.045, artículo 146 de la Ley N° 18.046 
                              y al artículo 1 de la Ley N°20.880, 
                              y que tengo el deber de informar sobre
                              cualquier situación que pueda dar origen a un
                              potecial conflicto de interés en el desempeño de
                              mis funciones.
                              <br />
                              <br />
                              Por lo anterior informo y declaro (marque con una "X" el
                          ...
                          <Row className="content">
                            <Row className="summary">
                              <Col xl={24}>
                                Indique a su cónyuge, conviviente y/o
                                ...
                                <Tooltip
                                  className="tooltip-form"
                                  title="Hasta segundo grado de afinidad, se consideran Padres, hijos que no sean suyos, Abuelos, Nietos y hermanos del cónyuge o conviviente civil "
                                >
                                  afinidad
                                </Tooltip>{" "}
                            ...
                            <Row>
                              <Col span={24} classname="form-required-messages">
                                  <em>*Es obligatorio ingresar al menos 2 registros</em>
                              </Col>
                            </Row>
                            <br />
                          ...
                          <Row className="summary">
                            <Col span={21}>
                              ...
                              conviviente y/o parientes hasta el segundo grado de{" "}
                              <Tooltip
                                className="tooltip-form"
                                title="Hasta segundo grado de consanguinidad, se consideran padres, hijos, abuelos, nietos y hermanos"
                              >
                          ...
                          <Row className="subheader">
                            <Col xl={24}>
                              III. RELACIONES LABORALES ANTERIORES (ÚLTIMOS 18 MESES)
                            </Col>
                          </Row>
                          <Row className="summary">
                            <Col span={21}>
                          ...
                          <Row className="summary">
                            <Col span={21}>
                              ...
                              con el giro de la Empresa o en conflicto con los
                              intereses de ella.
                            </Col>
                          ...
                          <Row className="summary">
                            <Col span={21}>
                              ...
                              , y/o mi pareja, conviviente o cónyuge son
                          ...
                          <Row className="summary">
                            <Col span={21}>
                              ...
                              de La Empresa o es mi conyuge o conviviente.
                            </Col>
                            {renderFormItem({
                              label: "",
                          ...
                          <Row className="summary">
                            <Col span={21}>
                              ...
                              lo hace mi cónyuge, conviviente y/o
                              parientes hasta el segundo grado de{" "}
                              <Tooltip
                                className="tooltip-form"
                                title="Hasta segundo grado de consanguinidad, se consideran padres, hijos, abuelos, nietos y hermanos"
                          ...
                          <Row className="summary">
                            <Col span={21}>
                              ...
                              amigos íntimos, parientes por consanguinidad o
                              afinidad hasta{" "}
                              <Tooltip title="Corresponde a los siguientes familiares: Bisabuelo(a), Biznieto(a), Tío(a) y Sobrino(a)">
                                <strong>tercer</strong>
                              </Tooltip>{" "}
                              y{" "}
                              <Tooltip title="Corresponde a los siguientes familiares: tatarabuelos, tataranietos, primos, tíos-abuelos y sobrinos-nietos">
                          ...
                          >
                            <Row className="summary">
                              <Col xl={24}>
                                ...
                                originen cambios a la presente declaración antes
                                de la siguiente presentación, con el objeto de
                                que se proceda a actualizar los antecedentes
                                entregados, y si fuera el caso, también tengo la
                                obligación de inhibirme de tomar decisiones que
                                pudieran verse afectadas por un posible
                                conflicto de interés declarado mientras este no
                                se resuelva.
                              </Col>
                            </Row>
                            {format === "html" && (
