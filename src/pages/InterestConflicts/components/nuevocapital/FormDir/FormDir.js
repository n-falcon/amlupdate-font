...
const FormDir = ({ form, match, formId }) => {
  ...
  const getTooltipTecerGrado = () => {
    ...
    return <strong>hasta el tercer grado</strong>
  }
  ...
  const SECTION1_HEADER = {
    ...
    Indique a su cónyuge, conviviente civil y/o parientes {" "}
      {getTooltipTecerGrado()}{" "}
        de{" "}
      { getTooltipConsanguinidad () }
      {" "}
      o{" "}
      { getTooltipAfinidad() }
      {" "}
  ...
  const SECTION2_HEADER = {
    ...
    text:
    <Col span={21}>
    Declaro que, hasta donde tengo conocimiento, participo, o lo hace mi cónyuge, conviviente civil y/o parientes
    {" "}
      {getTooltipTecerGrado()}{" "}
        de{" "}
      { getTooltipConsanguinidad () }
    ...
    {" "}
    inclusive, en
    sociedades, en forma directa o a través de otras personas naturales o jurídicas, con un 10% o más de su capital, o bien mi cónyuge y/o parientes {" "}
    {getTooltipTecerGrado()}{" "}
    de {getTooltipConsanguinidad()} o {getTooltipAfinidad()} inclusive ocupa el cargo de director, gerente, administrador, ejecutivo principal u otro equivalente en <strong>{repeatedCompany}</strong>,
    {" "}{getTooltipEmpresas('o alguna de sus empresas relacionadas')}.
  </Col>
  }
  ...
  const SECTION3_HEADER = {
    ...
    {" "}
      ...
      { getTooltipAfinidad()}
    {" "}
    inclusive, en sociedades, en
    forma directa o a través de otras personas naturales o jurídicas, con un 10% o más de su capital, o bien mi cónyuge y/o parientes {getTooltipTecerGrado()} de {getTooltipConsanguinidad()} o
    {getTooltipAfinidad()} inclusive ocupa el cargo de director, gerente, administrador, ejecutivo principal u otro equivalente en otras Sociedades, tanto en Chile como en el extranjero.
  </Col>
  }

  const SECTION4_HEADER = {
    title:
    <Row className="subheader">
      <Col xl={24}> IV. RELACIÓN CON PROVEEDORES Y/O CLIENTES INSTITUCIONALES DE LA EMPRESA {" "} </Col>
    </Row>,
    text:
    <Col span={21}>
    Declaro que tengo participación, directa o indirectamente, o lo hace mi cónyuge, conviviente civil y/o parientes
    {" "}
      {getTooltipTecerGrado()}{" "}
        de{" "}
      { getTooltipConsanguinidad() }
      ...
      { getTooltipAfinidad()}
    {" "}
    inclusive, hasta donde tengo conocimiento, en sociedades que son proveedoras,o clientes institucionales de <strong>{repeatedCompany}</strong> o de alguna de sus filiales, ya sea como
    propietario, socio, accionista principal, director, o como ejecutivo principal, gerente, administrador, o con cualquier cargo que suponga capacidad para tomar
    decisiones y obligar al proveedor,  y/o cliente institucional.
  </Col>
  }
  ...
  const SECTION5_HEADER = {
    title:
    <Row className="subheader">
      <Col xl={24}> V. RELACIONES LABORALES ANTERIORES (ÚLTIMOS 18 MESES) </Col>
    </Row> ,
    text:
    <Col span={21}>
      {format !== "html" && ( <> <br /> <br /> </> )}
  ...
  const SECTION6_HEADER = {
    title:
    <Row className="subheader">
      <Col xl={24}> VI. OTRAS ACTIVIDADES FUERA DE LA EMPRESA </Col>
    </Row>,
    text:
    <Col span={21}>
      Declaro que Participo o contribuyo en conferencias, seminarios, artículos a revistas e instituciones privadas o públicas, y/o realizo
      actividades docentes de cualquier tipo, en otros trabajos o actividades laborales que no entren en
      competencia con el giro de <strong>{repeatedCompany}</strong> y sus filiales o en conflicto con sus intereses.
    </Col>
  }
  ...
  const SECTION7_HEADER = {
    title:
    <Row className="subheader">
     <Col xl={24}>VII. RELACIÓN DE PARENTESCO CON TRABAJADORES DE LA COMPETENCIA </Col>
    </Row>,
    text:
    <Col span={21}>
      ...
      , conviviente civil o cónyuge son
  ...
  const SECTION8_HEADER = {
    title:
    <Row className="subheader">
     <Col xl={24}>VIII. RELACIÓN DE PARENTESCO O PAREJA CON TRABAJADORES DE LA EMPRESA</Col>
    </Row>,
    text:
    <Col span={21}>
      Declaro que tengo parentesco
     {" "}
      {getTooltipTecerGrado()}{" "}
        de{" "}
      { getTooltipConsanguinidad() }
      ...
      {getTooltipAfinidad()}
      {" "}
      inclusive o tengo una pareja que es trabajador(a) de <strong>{repeatedCompany}</strong> {getTooltipEmpresas('o de alguna de sus relacionadas')} o es mi conyuge o conviviente civil.
    </Col>
  }
  ...
  const SECTION9_HEADER = {
    title:
    <Row className="subheader">
     <Col xl={24}>IX. RELACIÓN CON FUNCIONARIOS PÚBLICOS Y/O PERSONAS EXPUESTAS POLÍTICAMENTE </Col>
    </Row>,
    text:
    <Col span={21}>
      ...
      o{" "}
      {getTooltipAfinidad()}
      , con funcionarios públicos, tanto en la administración central del Estado como en instituciones o empresas fiscales o semifiscales, municipales, autónomas u organismos
      creados por el Estado o bajo su dependencia; o con Personas Expuestas Políticamente
      {" "}
      <Tooltip
      ...
      {" "}
      , es decir, con personas que desempeñan o hayan desempeñado funciones públicas destacadas durante los últimos 12 meses.
    </Col>
  }


  const SECTION10_HEADER = {
    title:
    <Row className="subheader">
     <Col xl={24}>X. RELACIÓN CON FUNDACIONES, CORPORACIONES, INSTITUCIONES DE BENEFICIENCIA Y/O SIN FINES DE LUCRO</Col>
    </Row>,
    text:
    <Col span={21}>
      Declaro que participo, directa o indirectamente, o lo hace mi cónyuge, conviviente civil y/o parientes
      {" "}
      {getTooltipTecerGrado()}{" "}
        de{" "}
      { getTooltipConsanguinidad() }
      ...
      {getTooltipAfinidad()}
      {" "}
      , inclusive, como fundador, director, consejero, gerente, administrador, u otro similar, hasta donde tengo conocimiento, en fundaciones, corporaciones, instituciones
      de beneficencia y/o sin fines de lucro.
    </Col>
  }
  ...
  const SECTION11_HEADER = {
    title:
    <Row className="subheader">
    <Col xl={24}>XI. OTROS CONFLICTOS DE INTERÉS </Col>
  </Row>,
    text:
    <Col span={21}>
      Declaro que tengo conocimiento de algún otro conflicto de interés no abordado en las preguntas anteriores y que pudiera afectar o
      influir de cualquier forma en mi relación con {user.cliente && user.cliente.name}, tales como, existencia de relación comercial con amigos intimos,
      parientes por {" "}
      { getTooltipConsanguinidad() }
      {" "}
      o{" "}
      ...
      hasta
      {" "}
      <Tooltip title="Corresponde hasta los siguientes familiares: Bisabuelo(a), Bisnieto(a), Tío(a) y Sobrino(a)">
        <strong>tercer</strong>
      </Tooltip>{" "}
      y{" "}
      <Tooltip title="Corresponde hasta los siguientes familiares: tatarabuelos, tataranietos, primos, tíos-abuelos y sobrinos-nietos">
  ...
  const SECTION12_HEADER = {
    title:
    <Row className="subheader">
      <Col xl={24}> XII. CONOCIMIENTO DEL USO DE INFORMACIÓN CONFIDENCIAL, RESERVADA Y/O PRIVILEGIADA </Col>
    </Row>,
    text:
    <Col xl={24}>
  ...
  const SECTION13_HEADER = {
    title:
    <Row className="subheader">
      <Col xl={24}> XIII. CONOCIMIENTO DE LA LEY N°20.393 SOBRE “RESPONSABILIDAD PENAL DE LAS PERSONAS JURÍDICAS </Col>
    </Row>,
    text:
    <>
  ...
  const SECTION14_HEADER = {
    title:
    <Row className="subheader">
    <Col xl={24}>XIV. CONOCIMIENTO DECRETO LEY N° 211  </Col>
  </Row>,
    text:
    <Col span={24}>
      Declaro conocer y estar en cumplimiento del Decreto Ley N° 211 que fija normas para la defensa de la libre competencia, y en particular aquellas establecidas en el artículo
      3 letra d) de dicho cuerpo legal, en la cual cataloga como una conducta contraria a la libre competencia el hecho de que un director desempeñe dicho cargo en dos o más
      empresas competidoras entre sí, en tanto se cumplan ciertos requisitos, cuestión denominada internacionalmente como interlocking.
  </Col>
  }
  ...
  const SECTION15_HEADER = {
    title:
      <Row className="subheader">
        <Col xl={24}>XV. DECLARACIÓN DE RESPONSABILIDAD   </Col>
      </Row>,
    text:
    <>
      <Row className="summary">
        ...
        para <strong>{repeatedCompany}</strong> y sus filiales, y el cumplimiento por parte de éstas, de la normativa legal y regulatoria.
        </Col>
      </Row>
      <Row className="summary">
        <Col xl={24}>
                        ...
                        <>
                          ...
                          <Row className="summary">
                            <Col xl={24}>
                              ...
                              ,{" "}  con Rut <strong> {apiForm.recipient.record.rut} </strong>, en mi calidad de Director
                              , declaro: conocer el Código de Ética y Conducta de Negocios de{" "} <strong> {repeatedCompany} </strong>
                              {' '} y sus filiales (en adelante "La Empresa"),
                              ...
                              >
                                <strong>artículo 100 de la Ley N° 18.045</strong>
                              </Tooltip>{" "}
                              , al{" "}
                              <Tooltip
                                placement="rightBottom"
                                ...
                                title={() => {
                                  return (
                                    <>
                                      De acuerdo al Artículo 146 de la Ley de Sociedades Anónimas “LSA”.- Son operaciones con partes relacionadas
                                      de una sociedad anónima abierta toda negociación, acto, contrato u operación en que deba intervenir la
                                      ...
                                      <br />
                                      4) Aquellas que establezcan los estatutos de la sociedad o fundadamente identifique el comité de directores,
                                      en su caso, aun cuando se trate de aquellas indicadas en el inciso final del artículo 147.
                                      <br />
                                      5) Aquellas en las cuales haya realizado funciones de director, gerente, administrador, ejecutivo principal
                                      o liquidador, un director, gerente, administrador, ejecutivo principal o liquidador de la sociedad, dentro de
                              ...
                              >
                                <strong>artículo 146 de la Ley N° 18.046</strong>
                              </Tooltip>{" "}
                              <Tooltip
                                placement="rightBottom"
                                º
                                ...
                                title={() => {
                                  return (
                                    <>
                                      De acuerdo al Artículo 1 de la Ley N° 20.830 que crea el Acuerdo de Unión Civil que hace referencia el Artículo 42 del Código Civil: El acuerdo de unión civil es un contrato celebrado entre dos personas que comparten un hogar, con el propósito de regular los efectos jurídicos derivados de su vida afectiva en común, de carácter estable y permanente. Los contrayentes se denominarán convivientes civiles y serán considerados parientes para los efectos previstos en el artículo 42 del Código Civil.
                                    </>
                                  );
                                }}
                              >
                              <strong>y el artículo 1 de la ley 20.830</strong>
                              </Tooltip>{" "}
                              de todas las relaciones mías, de mi cónyuge y/o parientes {" "}
                              {getTooltipTecerGrado()}{" "}
                              de
                              {' '}{getTooltipConsanguinidad()} o {getTooltipAfinidad()} mayores de 18 años que mantienen con partes relacionadas. Por
                              lo anterior informo y declaro:
                            </Col>
                          </Row>
                          ...
                          {SECTION4_HEADER.title}
                          <Row className="summary">
                            {SECTION4_HEADER.text}
                            {renderFormItem({
                              label: "",
                              name: "hasRelProvCont",
                            ...
                            {format === "html" && (
                              <Row className="button-row">
                                <Col className="submitTrabajador" xl={24}>
                                  <Button type="primary" htmlType="submit" disabled={isSending} icon={isSending && 'loading'}>
                                    {t("messages.aml.send")}
                                  </Button>
                                </Col>
                              </Row>
