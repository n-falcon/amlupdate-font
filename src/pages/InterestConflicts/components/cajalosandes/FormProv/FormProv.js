                  ...
                  {apiForm.status === "SENT" && format === "html" ? (
                    ...
                    <>
                      ...
                      <Row className="summary">
                        <Col xl={24}>
                          {" "}
                          Yo {apiForm.name}, cédula nacional de
                          identidad N° {apiForm.rut}, con
                          domicilio en{" "}
                          {
                            <Form.Item
                          ...
                          , R.U.T. N°{" "}
                          {apiForm.recipient.record.rut} de mí
                      ...
                      <Row className="summary">
                        <Col span={21}>
                          ...
                          {smuProv}, posee una participación
                          social directa y/o indirecta, u ocupa el cargo de
                          director, gerente, ejecutivo principal o colaborador,en La Empresa{" "}
                        </Col>
                      ...
                      <Row className="summary">
                        <Col span={21}>
                          Declaro que tengo conocimiento de que algún director,
                          gerente, ejecutivo principal o administrador de{" "}
                          {smuProv}, presta servicios de
                          asesoría y/o consultoría a La Empresa{" "}
                        </Col>
                      ...
                      <Row className="summary">
                        ...
                        <Col span={21}>
                        Se entenderán como partes relacioandas para efectos de esta declaración:
                        <Row>
                          a)	Las entidades del grupo empresarial al que pertenece Caja Los Andes;
                        </Row>
                        <Row>
                          b)	Las personas jurídicas que tengan, respecto de Caja Los Andes,
                          la calidad de coligante, filial o coligada;
                        </Row>
                        <Row>
                          c)	Quienes sean directores, gerentes, administradores, ejecutivos
                          principales de Caja Los Andes y sus cónyuges o parientes hasta
                          el tercer grado de consanguinidad, así como toda entidad controlada,
                          directamente o a través de otras personas, por cualquiera de ellos;
                        </Row>
                        <Row>
                          d)	Las sociedades o empresas en las que las personas indicadas
                          en la letra c) precedente son dueños, directamente o a través
                          de otras personas naturales o jurídicas, de un 10% o más de su
                          capital, o directores gerentes, administradores, ejecutivos principales;
                        </Row>
                        <Row>
                          e)	Aquellas sociedades en las cuales haya realizado funciones de
                          director, gerente, administrador, ejecutivo principal, un director,
                          gerente, administrador de Caja Los Andes, dentro de los últimos 18 meses
                        </Row>
                        </Col>
                      </Row>
                      ...
                      <Row className="summary">
                        <Col span={21}>
                          Declaro que tengo conocimiento de que algún director,
                          gerente, ejecutivo principal o administrador de{" "}
                          {smuProv} ha ejercido funciones en{" "}
                          La Empresa, dentro de los últimos 18
                          meses.
                        </Col>
                        {renderFormItem({
                          label: "",
                      ...
                      <Row className="summary">
                        <Col span={21}>
                          Declaro que tengo conocimiento de que algún director,
                          gerente, ejecutivo principal o administrador de{" "}
                          {smuProv} tiene interés en la
                          propiedad o gestión de La Empresa.
                        </Col>
                      ...
                      <Row className="summary">
                        <Col span={21}>
                          Declaro que tengo conocimiento de que algún director,
                          gerente, ejecutivo principal o administrador de{" "}
                          {smuProv} es o ha sido un empleado o
                          ...
                          dependencia; o es una Persona Expuesta Políticamente (PEP)
                      ...
                      <Row className="summary">
                        <Col span={21}>
                          ...
                          relación de {smuProv} con La Empresa.
                        </Col>
